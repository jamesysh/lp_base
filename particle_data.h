...
public:	
 ...
 //-----------------OUTPUT CONTROL-------------------------------------
    ...
    int m_iPrintVelocityU;
    int m_iPrintVelocityV;
    int m_iPrintVelocityW;
    int m_iPrintVolume;
    int m_iPrintDensity;
    int m_iPrintMass;
    int m_iPrintPressure;
    int m_iPrintSoundSpeed;
    int m_iPrintLeftIntegral;
    int m_iPrintRightIntegral;
    int m_iPrintDeltaq;
