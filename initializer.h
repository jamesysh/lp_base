...
//	std::size_t getGhostStartIndex() const {return m_iGhostStartIndex;}
   ...
   int getPrintVolume(){return m_iPrintVolume;}
   ...
   int getPrintLeftIntegral(){return m_iPrintLeftIntegral;}

   int getPrintRightIntegral(){return m_iPrintRightIntegral;}

   int getPrintDeltaq(){return m_iPrintDeltaq;}

   int getPrintQplusminus(){return m_iPrintQplusminus;}
...
private:
    ...
    int m_iPrintVolume = 0;
    int m_iPrintDensity = 0;
    int m_iPrintMass = 0;
    int m_iPrintPressure = 0;
    int m_iPrintSoundSpeed = 0;
    int m_iPrintLeftIntegral = 0;
    int m_iPrintRightIntegral = 0;
    int m_iPrintDeltaq = 0;
