...
int OctreeSearcher::buildSearchStructure_integral(const double* x, const double* y, const double* z, const double* m, const double* vv, size_t begin, size_t numParticles,const double* x_temp) {
  return m_pOctree_integral->buildOctree(x+begin, y+begin, z+begin,m+begin, vv+begin, numParticles,x_temp);
