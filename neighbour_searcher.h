...
public:
	...
	virtual int buildSearchStructure_integral(const double* x, const double* y, const double* z, const double* m, const double* vv, size_t begin, size_t numParticles, const double* x_temp) = 0;
	/**
	 * \brief Build the data structure for the nearest neighbour search, based on 
...
public:
	...
	virtual int buildSearchStructure(const double* x, const double* y, const double* z, size_t begin, size_t numParticles);
     ...
     int buildSearchStructure_integral(const double* x, const double* y, const double* z, const double* m, const double* vv, size_t begin, size_t numParticles, const double* x_temp);
#ifdef _OPENMP
	/**
